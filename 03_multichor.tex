...
\MultiChor's \inlinecode{Faceted} values and utilities for type-safe embedding of enclaved sub-protocols within larger censuses
...
and uses \inlinecode{enclaveTo} (line 34) to embed pairwise OTs (via \inlinecode{ot2}) in the larger set of parties.
