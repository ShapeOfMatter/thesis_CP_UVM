...
The choreography in \Cref{fig:kvsenclave}\emph{(a)}
...
\Cref{fig:our-kvs} shows a \HLSCentral version of the amended choreography from \Cref{fig:kvsenclave}\emph{(b)}.
...
\begin{figure}[tbhp]
  ...
  \begin{minipage}{0.95\linewidth}
    ...
    The \inlinecode{case} expression (line~4) explicitly enclaves to the sub-census \inlinecode{[primary,backup]}.
    Although the choreography looks (and in practice would execute) very much like the \MultiChor version in \Cref{fig:kvsenclave}\emph{(b)},
  ...
  \end{minipage}
    \caption{A \HLSCentral choreography implementing the same KVS as in \Cref{fig:kvsenclave}.}
    \label{fig:our-kvs}
