...
\section{A Formal Conclaves-\&-MLVs Language}
\label{sec:more-formalism}
...
\begin{figure}[tbhp]
  ...
  \begin{minipage}{0.95\linewidth}
    \inputminted[xleftmargin=10pt,linenos,fontsize=\footnotesize]{bash}{figures/kvs_hls.txt}
  \end{minipage} \\\\
  \begin{minipage}{0.95\linewidth}
...
\begin{figure}[tbhp]
  ...
  \begin{tabular}{c}
  \begin{minipage}{0.95\linewidth}
    \inputminted[xleftmargin=10pt,linenos,fontsize=\footnotesize]{bash}{figures/sequential_hls.txt}
  \end{minipage} \\\\
  \begin{minipage}{0.95\linewidth}
	  This choreography involves two clients and one server.
  ...
  \end{minipage}
  \end{tabular}
    \caption{A \HLSCentral implementation of a choreography involving sequential branches.}
...
\begin{figure}[tbhp]
  ...
  \begin{tabular}{c}
  \begin{minipage}{0.95\linewidth}
    \begin{minted}[xleftmargin=10pt,linenos,fontsize=\footnotesize]{bash}
if alice.choice
  then alice[L] ~> bob;
...
\begin{figure}[tbhp]
  ...
  \begin{tabular}{c}
  \begin{minipage}{0.95\linewidth}
    \inputminted[xleftmargin=10pt,linenos,fontsize=\footnotesize]{bash}{figures/contrived_lc.txt}
  \end{minipage}
  \end{tabular}
...
\begin{figure}[tbhp]
  ...
  \end{minipage}
  \end{tabular}
    \caption{An algorithmic \HLSCentral translation of the choreography from \Cref{fig:chor-lambda-complex}.}
