...
\begin{citationspage}
\vskip 2em
Material from this proposal has been submitted for publication in {\it PLDI} on 06/16/2025 in the following form:\\
\vskip 2em 
...
\vskip 1em 
(\textit{NB:} This will still be in a state of uncertainty when I defend the proposal.
Specifically, we will have responded to the first round of reviews and be awaiting subsequent decision.)
\vskip 2em
...
\vskip 2em
\noindent Mako Bates and Joseph P. Near.
          (2024). We Know I Know You Know; Choreographic Programming With Multicast and Multiply Located Values. {\it CP24}
	  \url{https://youtu.be/mnjhUZM4krU?si=Whx7l1F_UZUdDN2h}
\vskip 2em
Material from this proposal is additionally available as archived pre-prints in the following forms:
\vskip 2em
\noindent Bates, Mako, and Joseph P. Near. ‘We Know I Know You Know; Choreographic Programming With Multicast and Multiply Located Values’. arXiv [Cs.PL], 2024. arXiv. \url{http://arxiv.org/abs/2403.05417}.
\vskip 2em
\noindent Bates, Mako, Syed Jafri, and Joseph P. Near. ‘MultiChor: Census Polymorphic Choreographic Programming with Multiply Located Values’. arXiv [Cs.PL], 2024. arXiv. \url{http://arxiv.org/abs/2406.13716}.
\vskip 2em
Tools described in this proposal are availibe for use in the following from:
\vskip 2em
\noindent Mako Bates. 2024. MultiChor: Type-safe and efficient choreographies with location-set polymorphism. \url{https://hackage.haskell.org/package/MultiChor-1.0.1.1}
\end{citationspage}
