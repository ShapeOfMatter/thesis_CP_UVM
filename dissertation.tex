...
\begin{citationspage}
\vskip 2em
Material from this dissertation has been accepted for publication in {\it PLDI} on 06/216/2025 in the following form:\\
TODO: Hopefully! Hopefully, this will still be in a state of uncertainty when I defend the proposal.
I'm also unclear if I should actually be using this page; I think it depends on the extent to which I'm actually using the exact same material vs refurbishing...
\vskip 2em 
...
Alan Turing (1912-1954) \\
	IDK if i'll keep this page at all...}
\end{dedication}
