...
For example, EPP of the choreography in \Cref{fig:kvsconclave}\emph{(b)} to each of the three participants
...
\Cref{fig:kvsconclave}\emph{(a)} implements HasChor's KoC strategy: the branch guard is broadcast to everyone.
